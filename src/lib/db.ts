...
function seedGlossary(db: Database.Database) {
  ...
  const terms: [string, string, string, string, string, string | null][] = [
    ...
    ["Duration", "Renta Fija",
      ...
      "Un bono con Modified Duration 4,5 baja ~4,5% si la TNA sube 100 bps.", null],
    ["Convexidad", "Renta Fija",
      ...
      "Si la tasa baja 200 bps, la suba de precio supera la predicción de la Duration por efecto de la convexidad.", null],
    ["Bootstrapping", "Renta Fija",
      ...
      "Con un bono a 1 año que paga cupón y otro a 2 años, se obtiene la tasa spot a 2 años despejando de su precio.", null],
    ["Curva spot", "Renta Fija",
      ...
      "La tasa spot a 3 años indica a qué tasa anual un peso recibido en 3 años equivale a uno hoy.", null],
    ["Curva par", "Renta Fija",
      ...
      "Una tasa par a 5 años del 8% implica que un bono que paga 8% anual se cotiza a 100.", null],
    ["Curva forward", "Renta Fija",
      ...
      "Si la spot a 1Y es 5% y a 2Y es 6%, la forward 1Y×2Y es aproximadamente 7%.", null],
    ["YTM", "Renta Fija",
      ...
      "AL35 a 64 dólares con pagos semestrales tiene una YTM cercana al 14% anual en USD.", "AL35.BA"],
    ["TIR", "Renta Fija",
      ...
      "Un proyecto que requiere $100 hoy y devuelve $121 en 2 años tiene una TIR del 10% anual.", null],
    ["Precio limpio vs sucio", "Renta Fija",
      ...
      "Un bono cotiza a 95 (limpio) con 1,5 de cupón corrido: se pagan 96,5 (sucio) al liquidar.", null],
    ["Amortización francesa", "Renta Fija",
      ...
      "Un préstamo de $100.000 a 12 meses al 5% mensual tiene la misma cuota todos los meses.", null],
    ["LECAP", "Renta Fija",
      "Letra del Tesoro en pesos a descuento; tasa fija en moneda local.",
      "Son letras emitidas por el Tesoro Nacional con descuento inicial. La ganancia es la diferencia entre el precio de compra y el valor nominal al vencimiento.",
      "Una LECAP a 90 días comprada a $95 y que vence a $100 rinde ~21% TNA.", null],
    ["BONCER", "Renta Fija",
      "Bono del Tesoro ajustado por CER (inflación) con cupón real fijo.",
      "El capital se ajusta diariamente por el índice CER. Ofrece rendimiento real positivo sobre inflación, protegiendo contra la erosión del poder adquisitivo.",
      "Un BONCER con cupón real del 2% rinde inflación + 2% anual.", null],
    ["BOPREAL", "Renta Fija",
      "Bono para la Reconstrucción de una Argentina Libre; emitido por el BCRA en 2024.",
      "Creado para regularizar deudas comerciales en dólares con importadores. Permite a empresas deudoras cancelar sus pasivos en dólares a cambio de estos bonos.",
      "Una empresa con deuda comercial de USD 1M puede suscribir BOPREAL y cancelar esa deuda.", null],
    ["AL35", "Renta Fija",
      ...
      "AL35 cotiza en el mercado local en pesos; al dividir por el CCL implícito se obtiene su precio en USD.", "AL35.BA"],
    ["GD35", "Renta Fija",
      ...
      "El spread AL35-GD35 refleja la prima de riesgo legal argentina vs NY.", "GD35.BA"],
    ["ON (Obligación Negociable)", "Renta Fija",
      ...
      "Las ON pueden estar en USD, pesos o indexadas a CER/UVA. Ofrecen mayor rendimiento que soberanos por riesgo corporativo.",
      "YPF emite una ON hard dollar al 8,5% anual con vencimiento a 5 años.", null],
    ["LETE", "Renta Fija",
      ...
      "Una LETE a 180 días cotiza a USD 97 y vence a USD 100, rindiendo ~6% TNA en USD.", null],
    ["LECER", "Renta Fija",
      ...
      "Una LECER a 3 meses con tasa real de 0% rinde exactamente inflación en ese período.", null],

    // ── Renta Variable ──────────────────────────────────────────────────────
    ["P/E", "Renta Variable",
      "Price-to-Earnings: precio de la acción dividido por la ganancia por acción.",
      "Indica cuántos años de ganancias actuales se pagan por la acción. Un P/E alto puede reflejar expectativas de crecimiento futuro o sobrevaluación.",
      "Si GGAL cotiza a $1.000 y su EPS es $100, su P/E es 10x.", "GGAL.BA"],
    ["EV/EBITDA", "Renta Variable",
      "Enterprise Value sobre EBITDA: múltiplo de valoración independiente de la estructura de capital.",
      "EV = Market Cap + Deuda Neta. Al dividir por EBITDA se obtiene cuántos años de generación operativa se pagan.",
      "YPF con EV de $5.000M y EBITDA de $1.000M tiene un múltiplo de 5x EV/EBITDA.", "YPFD.BA"],
    ["DCF", "Renta Variable",
      ...
      "Una empresa que genera $100M anuales creciendo al 3%, descontado al 10%, vale $1.428M.", null],
    ["WACC", "Renta Variable",
      "Weighted Average Cost of Capital: costo promedio ponderado del capital de una empresa.",
      "Combina el costo del equity (CAPM) y el costo de la deuda después de impuestos, ponderados por su participación en el financiamiento total.",
      "Con 60% equity a 15% y 40% deuda a 5,6% post-tax, el WACC = 11,24%.", null],
    ["Beta", "Renta Variable",
      "Sensibilidad del retorno de una acción respecto al retorno del mercado.",
      "Beta = 1: se mueve igual que el mercado. Beta > 1: más volátil. Beta < 1: defensivo. Se estima por regresión histórica.",
      "GGAL con Beta 1,4 sube 14% cuando el Merval sube 10%.", null],
    ["ROE", "Renta Variable",
      "Return on Equity: rentabilidad sobre el patrimonio neto de los accionistas.",
      "ROE = Ganancia Neta / Patrimonio Neto. Mide la eficiencia con la que la empresa usa el capital aportado por los accionistas.",
      "Banco Galicia con ganancia de $50.000M y PN de $200.000M tiene un ROE del 25%.", null],
    ["ROA", "Renta Variable",
      "Return on Assets: rentabilidad sobre los activos totales de la empresa.",
      "ROA = Ganancia Neta / Activos Totales. Mide qué tan eficientemente la empresa usa todos sus recursos para generar ganancias.",
      "Una empresa con activos de $1.000M y ganancia de $80M tiene un ROA del 8%.", null],
    ["Free float", "Renta Variable",
      "Porcentaje de acciones de una empresa que se negocian libremente en el mercado.",
      "Excluye acciones en manos de controlantes y directivos. Un free float bajo implica menor liquidez y mayor volatilidad.",
      "Si YPF tiene 51% del Estado y 15% de controlantes, el free float es 34%.", "YPFD.BA"],
    ["Dividend yield", "Renta Variable",
      "Dividendo anual por acción dividido por el precio de mercado de la acción.",
      "Mide el retorno por dividendos sobre el precio pagado. Empresas maduras suelen tener alto dividend yield.",
      "Una acción a $500 que paga $25 anuales en dividendos tiene un dividend yield del 5%.", null],
    ["CEDEAR", "Renta Variable",
      "Certificado de Depósito Argentino que representa acciones extranjeras cotizadas en Argentina.",
      "Cada CEDEAR representa una fracción de una acción global. Cotizan en pesos pero están dolarizados al CCL implícito, funcionando como cobertura cambiaria.",
      "AAPL CEDEAR (ratio 10:1): 10 CEDEARs = 1 acción de Apple.", null],

    // ── Derivados ───────────────────────────────────────────────────────────
    ["Call", "Derivados",
      "Opción que da el derecho (no la obligación) de comprar el activo subyacente a precio strike.",
      "El comprador de un call paga una prima y tiene upside ilimitado. El call está in-the-money si el precio spot supera al strike.",
      "Call GGAL strike $1.200 con prima $50: si GGAL sube a $1.400, el comprador gana $150 neto.", null],
    ["Put", "Derivados",
      "Opción que da el derecho (no la obligación) de vender el activo subyacente a precio strike.",
      "El comprador de un put gana cuando el subyacente baja por debajo del strike. Funciona como seguro de cartera.",
      "Put AL35 strike $60 con prima $3: si AL35 cae a $50, el comprador gana $7 neto.", null],
    ["Greeks (Delta, Gamma, Theta, Vega)", "Derivados",
      "Métricas de sensibilidad de una opción ante cambios en variables de mercado.",
      "Delta: cambio en precio de la opción por $1 en el subyacente. Gamma: tasa de cambio del Delta. Theta: pérdida diaria por tiempo. Vega: sensibilidad a la volatilidad implícita.",
      "Una opción con Delta 0,5 sube $0,50 si el subyacente sube $1. Theta -$2 pierde $2 por día.", null],
    ["Volatilidad implícita", "Derivados",
      "Volatilidad que, introducida en Black-Scholes, reproduce el precio de mercado de una opción.",
      "Es la volatilidad que el mercado espera en el futuro, extraída del precio de la opción. Sube en momentos de incertidumbre.",
      "Si el VIX supera 30, el mercado descuenta alta turbulencia en el S&P 500.", null],
    ["Smile de volatilidad", "Derivados",
      "Patrón donde la volatilidad implícita varía según el strike de las opciones.",
      "Black-Scholes asume vol constante, pero el mercado muestra que opciones OTM tienen mayor vol implícita. Refleja el tail risk.",
      "Para opciones sobre el S&P 500, los puts OTM tienen mayor vol implícita que las ATM.", null],
    ["Futuros", "Derivados",
      "Contratos estandarizados de compraventa futura de un activo a un precio y fecha fijados hoy.",
      "Se negocian en mercados organizados (ROFEX en Argentina). Requieren margin calls diarios. No hay pago inicial del principal.",
      "Futuro de dólar ROFEX a 30 días a $1.100: si el spot llega a $1.150, el comprador gana $50.", null],
    ["Forward", "Derivados",
      "Contrato OTC de compraventa futura similar al futuro pero no estandarizado.",
      "Se acuerda entre dos partes, con términos a medida (monto, fecha, precio). No hay liquidación diaria. Mayor riesgo de contraparte.",
      "Una exportadora acuerda un forward a 90 días para vender USD 1M a $1.050, asegurando su ingreso.", null],
    ["Swap", "Derivados",
      "Acuerdo para intercambiar flujos de caja entre dos partes en fechas futuras.",
      "El más común es el interest rate swap (IRS): una parte paga tasa fija y recibe tasa variable (BADLAR).",
      "Un banco con pasivos a tasa variable entra en un swap pagando fijo y recibiendo BADLAR para cubrirse.", null],
    ["Caución bursátil", "Derivados",
      "Operación de pase en el mercado de capitales argentino equivalente a un repo a corto plazo.",
      "El tomador entrega títulos como garantía y recibe fondos, comprometiéndose a recomprarlos al vencimiento.",
      "Un fondo colocador presta $1M a tasa de caución 70% TNA por 7 días, garantizado con bonos.", null],
    ...
    ["BADLAR", "Tasas & Curvas",
      ...
      "Si la BADLAR es 97% TNA, un fondo money market que rinde BADLAR + 2% rinde ~99% TNA.", null],
    ["Tasa política monetaria", "Tasas & Curvas",
      ...
      "El BCRA la usa como ancla de la política monetaria. Desde 2024 es la tasa de pases pasivos a 1 día.",
      "Con tasa de política al 60% TNA, un plazo fijo a 30 días rinde aproximadamente 4,9% mensual.", null],
    ["Tasa real vs nominal", "Tasas & Curvas",
      ...
      "TNA 100% con inflación 120% anual: tasa real ≈ -9% (negativa).", null],
    ["Spread", "Tasas & Curvas",
      "Diferencial de rendimiento entre dos instrumentos o tasas de referencia.",
      "Puede ser Z-spread, OAS o simplemente la diferencia entre YTMs de dos bonos.",
      "GD35 rinde 14% y el US Treasury 10Y rinde 4,5%; el spread soberano es ~950 bps.", null],
    ["CER", "Tasas & Curvas",
      "Coeficiente de Estabilización de Referencia: índice de actualización por inflación del BCRA.",
      "Se publica diariamente con un rezago de ~45 días respecto al IPC. Se usa para ajustar el capital de instrumentos CER.",
      "Si el CER sube 8% en un mes, el capital de un BONCER sube 8%.", null],
    ["Tasa libre de riesgo", "Tasas & Curvas",
      ...
      "En USD se usa la curva del Tesoro de EE.UU. (T-bills, T-bonds). El CAPM la usa como base.",
      "Si la T-bill a 3 meses rinde 5,2% y se exige 8% de prima de riesgo, el costo del equity mínimo es 13,2%.", null],

    // ── Instrumentos AR ─────────────────────────────────────────────────────
    ["AO27", "Instrumentos AR",
      "Bono del Tesoro en USD con vencimiento en julio de 2027, ley argentina.",
      "Bono dolarizado emitido por el Tesoro Nacional. Paga cupones semestrales en USD y amortiza al vencimiento.",
      "AO27 a precio USD 95 con cupón del 3,5% anual tiene una YTM aproximada del 6% en USD.", "AO27.BA"],
    ["AO28", "Instrumentos AR",
      "Bono del Tesoro en USD con vencimiento en 2028, ley argentina.",
      "Similar al AO27 pero con mayor plazo. Parte de la curva soberana en USD ley local.",
      "El spread AO28-GD29 refleja la prima de ley argentina versus Nueva York.", "AO28.BA"],

    // ── Macro Argentina ─────────────────────────────────────────────────────
    ["Brecha cambiaria", "Macro Argentina",
      "Diferencia porcentual entre el tipo de cambio libre (CCL o blue) y el oficial.",
      "Una brecha alta incentiva la subfacturación de exportaciones. Distorsiona el comercio exterior y genera presiones devaluatorias.",
      "Con dólar oficial $1.000 y CCL $1.400, la brecha es del 40%.", null],
    ["Dólar MEP", "Macro Argentina",
      "Dólar Mercado Electrónico de Pagos: tipo de cambio implícito en la compraventa de bonos.",
      "Se compra un bono en pesos y se vende la misma especie en USD en el mismo mercado local. Es legal y no requiere MULC.",
      "Comprando AL30 a $75.000 y vendiéndolo en USD a USD 55, el MEP implícito es $1.363.", null],
    ["CCL", "Macro Argentina",
      "Contado con Liquidación: tipo de cambio libre obtenido via compraventa de activos en distintas plazas.",
      "Se compra un activo en Argentina (pesos) y se vende en el exterior (USD). Es el tipo de cambio relevante para CEDEARs.",
      "GD30 en pesos a $85.000 y en USD a USD 60 en NYSE implica CCL de $1.416.", null],
    ["MULC", "Macro Argentina",
      "Mercado Único y Libre de Cambios: mercado oficial donde opera el BCRA.",
      "Es el mercado cambiario regulado donde se transan exportaciones, importaciones y deuda. El BCRA interviene fijando el tipo de cambio oficial.",
      "Las exportaciones de soja deben liquidarse en el MULC al tipo de cambio oficial.", null],
    ["Reservas brutas vs netas", "Macro Argentina",
      ...
      "Reservas netas = brutas menos encajes en USD, swap con China, SEDESA y otros pasivos. Son el indicador relevante de la capacidad de intervención del BCRA.",
      "Con brutas USD 27.000M y pasivos de USD 20.000M, las netas son solo USD 7.000M.", null],
    ["Base monetaria", "Macro Argentina",
      "Agregado monetario primario: billetes en circulación más reservas bancarias en el BCRA.",
      "Es el pasivo monetario del BCRA. Su expansión puede generar inflación si supera la demanda de dinero.",
      "Una base monetaria que crece al 120% anual cuando la demanda de dinero cae presiona al alza el nivel de precios.", null],
    ["Leliq", "Macro Argentina",
      "Letras de Liquidez del BCRA: instrumento de esterilización monetaria a 28 días.",
      "El BCRA las emite para absorber pesos excedentes. Los bancos las compran con los depósitos de sus clientes. Implican una deuda remunerada del BCRA.",
      "Con $20 billones en Leliqs al 97% TNA, el BCRA paga intereses que retroalimentan la emisión.", null],
    ["Pases pasivos", "Macro Argentina",
      "Operaciones repo de cortísimo plazo (1 día) entre el BCRA y los bancos.",
      "Desde 2024 reemplazaron a las Leliqs como principal instrumento de esterilización. Son la tasa de política monetaria de referencia.",
      "Con pases pasivos al 60% TNA, los bancos depositan excedentes en el BCRA ganando ~4,9% mensual.", null],
  ];
